...
//         {/* write code for list fetched service name and total cost  */}
//         <div className="row g-3 mb-3">
//           <label htmlFor="service" className="col-md-2 col-form-label col-form-label-sm"> Services</label>
//           <div className="col-md-6">
//             <div className="form-control-sm p-0">
//               <select
//                 id="services"
...
const SaleData = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://127.0.0.1:8000/api/v1/transactions/", {
        ...formData,
  ...
  return (
    <div className="panel">
      <form onSubmit={handleSubmit}>
        {/* Customer Input */}
        <div className="row g-3 mb-3">
          <label htmlFor="customer" className="col-md-2 col-form-label col-form-label-sm">
            Customer
          </label>
          <div className="col-md-6">
            <input
